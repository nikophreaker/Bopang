...
include"../../koneksi.php";
$e=$_GET['id'];
$edit=mysql_query("SELECT * FROM produk WHERE id_produk='$e'");
$produk = mysql_fetch_array($edit);
?>
...
<form action="e_produk.php" method="post" enctype="multipart/form-data">
 		...
 		<b>Tanggal Kadaluarsa : </b><input type="text" name="tgl_kadaluarasa" class="form-control" value =" <?php  echo $produk['tgl_kadaluarasa'];?>"><br>
