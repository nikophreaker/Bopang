...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			mysql_query("INSERT into produk set rasa='$rasa',id_ketegori='$id_kategori',tgl_produksi='$tgl_produksi',tgl_kadaluarsa='$tgl_kadaluarsa',harga='$harga', gambar='$nama_file_baru', stok='$stok'");
